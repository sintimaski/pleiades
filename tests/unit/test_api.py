...
class TestCrossMatchAPI:
    ...
    def test_cross_match_raises_on_invalid_radius(self) -> None:
    ...
    def test_cross_match_raises_on_missing_catalog_a(self) -> None:
    ...
    def test_cross_match_progress_callback_called(self) -> None:
